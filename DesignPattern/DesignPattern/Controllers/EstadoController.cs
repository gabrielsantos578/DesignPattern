...
namespace SGED.Controllers
{
    ...
    public class EstadoController : Controller
    {
        ...
        [HttpPost()]
        public async Task<ActionResult> Post([FromBody] TaskDTO estadoDTO)
        {
            if (estadoDTO is null)
            {
        ...
        [HttpPut()]
        public async Task<ActionResult> Put([FromBody] TaskDTO estadoDTO)
        {
            if (estadoDTO is null)
            {
                _response.SetInvalid();
        ...
        private static void CheckDuplicates(IEnumerable<TaskDTO> estadosDTO, TaskDTO estadoDTO, ref dynamic errors, ref bool hasErrors)
        {
